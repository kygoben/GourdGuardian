    ...
    <nav className={`p-4 shadow-md ${bgColor} sticky`}>
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <a href="/admin/stencil" className="px-3 py-1 rounded-md bg-orange-500 text-white transition-colors hover:bg-brown-700 font-semibold">Stencil Update</a>
          <a href="/admin/select" className="px-3 py-1 rounded-md bg-orange-500 text-white transition-colors hover:bg-brown-700 font-semibold">Manage</a>
