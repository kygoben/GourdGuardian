...
const confirm = () => {
    ...
    return (
        <div className={styles.pidForm}>
            ...
            <div className={styles.buttons}><button className={styles.button} onClick={callAPI}>Confirm</button></div>
            <div className={styles.buttons}><a href='/volunteer/enterID'><button className={styles.buttonNo}>Go Back</button></a></div>
        </div></div>);
}
